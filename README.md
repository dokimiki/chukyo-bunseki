...
| **出力**               | _Markdown_ 調査レポート、_Graphviz DOT_ サイトマップ、_JSON_ API 一覧、Playwright Trace ZIP                |
...
| ツール                 | バージョン                                                                 |         |
| ---------------------- | -------------------------------------------------------------------------- | ------- |
| **Rust**               | 1.87.0 (cargo 含む)                                                        |         |
| **Tauri CLI**          | `cargo install tauri-cli`                                                  |         |
| **Bun**                | 1.2.16 以上 (\`curl -fsSL [https://bun.sh/install](https://bun.sh/install) | bash\`) |
